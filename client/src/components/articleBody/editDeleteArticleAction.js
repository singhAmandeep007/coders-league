...
const EditDeleteArticleAction = ({ articleData }) => {
   ...
   return (
      <Segment basic compact style={{ margin: '0em' }}>
         <Link to={{
            pathname: `/a/edit/${articleData.slug}`,
            articleData: { ...articleData }
         }}>
            <Button inverted compact animated color='orange'>
         ...
         <Modal
            ...
            onOpen={() => setOpen(true)}
            open={open}
            trigger={<Button inverted compact animated color='red'>
         ...
         >
            ...
            <Modal.Actions>
               ...
               <Button positive onClick={() => deleteArticle()}>Yes</Button>
            </Modal.Actions>
         </Modal>
      </Segment>
   )
