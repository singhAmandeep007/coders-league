         ...
         <Segment color='blue' raised>
            ...
            >
               ...
               <Form.Field error={!!errors.bio} >
                  ...
                  <textarea id='update-bio' placeholder="Just a normal guy." name="bio" ref={register()} rows="4" />
               ...
               {updateStatus.visibleMessage && <Message
                  error={!!updateStatus.errors}
                  success={updateStatus.statusCode === 200 ? true : false}
                  onDismiss={handleDismiss}
                  icon='bullhorn'
                  content={updateStatus.errors ? (updateStatus.errors || 'Error occured while updating profile.') : 'Your profile has been updated.'}
               />}
               ...
               <button className="ui fluid button" type="button" onClick={() => clearErrors()}>Reset</button>
            </Form>
         </Segment>
